...
const NavLinks: React.FC<NavLinksProps> = (props: NavLinksProps) => {
    ...
    return (
        ...
        <nav
            ...
            <ul className="flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium sm:w-[initial] text-muted-foreground sm:flex-nowrap sm:gap-5">
                {
                    links.map(link => (
                        <motion.li
